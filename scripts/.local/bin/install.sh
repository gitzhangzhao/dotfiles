...
function install_required_packages() {
    # Refresh apt
    sudo apt update
    sudo apt install xserver-xorg x11-xserver-utils firmware-iwlwifi firmware-linux-nonfree unzip binutils gcc make pulseaudio pavucontrol pulseaudio-module-bluetooth python3 python3-pip lightdm
    # for picom runtime
    sudo apt install libpcre3 libxcb-damage0 libconfig9
}
